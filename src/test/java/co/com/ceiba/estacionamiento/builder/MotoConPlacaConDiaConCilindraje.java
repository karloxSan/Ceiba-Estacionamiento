...
/**
 * Clase que construye un parqueo de moto con la restriccion de la placa y
 * cilindraje
 *
 */
public class MotoConPlacaConDiaConCilindraje extends ParqueoEntradaDtoBuilder {
	...
	public void bluidFechaIngreso() {
		...
		try {
			Date date = sdf.parse("2018-08-27 15:03:23");
