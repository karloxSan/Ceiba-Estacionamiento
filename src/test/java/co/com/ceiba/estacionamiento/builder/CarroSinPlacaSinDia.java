...
/**
 * Clase que construye un parqueo de carro sin la restriccion de la placa
 *
 */
public class CarroSinPlacaSinDia extends ParqueoEntradaDtoBuilder {

	@Override
	public void bluidPlaca() {
		parqueoEntradaDto.setPlaca("XVS201");
	}
